...
class Comment extends ApiAbstract
{
    ...
    public function markelect($msg_data_id, $user_comment_id, $index = null)
    {
        ...
        $this->httpPost("/comment/markelect?access_token={$this->accessToken}", $params);
    }
    ...
    public function unmarkelect($msg_data_id, $user_comment_id, $index = null)
    {
        ...
        $this->httpPost("/comment/unmarkelect?access_token={$this->accessToken}", $params);
    }
    ...
    public function delete($msg_data_id, $user_comment_id, $index = null)
    {
        ...
        $this->httpPost("/comment/delete?access_token={$this->accessToken}", $params);
    }
}
